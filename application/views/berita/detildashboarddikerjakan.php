                    ...
                    <div id="horizontalFormExample" class="panel-collapse collapse in">
                        <div class="portlet-body">
                            ...
                            <div class="btn-group btn-group-justified">
                                ...
                                <a href="#" class="btn btn-green" role="button">Dikerjakan</a>
                            </div>
                            <?php
                            if ($notif2 != "") {
                                ?>
                            ...
                            <div class="portlet portlet-green">
                                <div class="portlet-heading">
                                    <div class="portlet-title">
                                        <center><h4>Daftar Berita Fungsi <?php echo $data_fungsi[0]['nama_fungsi']; ?> yang Sudah Dikerjakan</h4></center>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="portlet-body">
                                                        ...
                                                        <tr id="row">
                                                            ...
                                                            <td width="10%">
                                                                ...
                                                                if ($val['berita_status_pengerjaan'] == 'Y') {
                                                                    ?>
                                                                    <a class="btn btn-xs btn-green"><i class="fa fa-check"></i> Dikerjakan</a>
                                                                    <?php
                                                                } else {
                                                                    ?> 
