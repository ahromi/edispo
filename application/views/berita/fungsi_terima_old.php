                                    	...
                                    	<td>
                                            <table id="">
                                                ...
                                                <? foreach($fungsi_disposisi as $key) { ?>
                                                    <li><? if ($key['fungsi_kd']==$level_id) 
														{ echo "<b><i>".$key['nama_fungsi']."</i></b>"; } 
														else { echo $key['nama_fungsi']; }?></li>
                                                <? } ?>
                                                    </ul>
                                                    </td>
                                                </tr>
									...
									if ($key['detail_terima']=='Y') { $status='Sudah Menerima pada '.$key['detail_waktu']; } else { $status='Belum Menerima';  }
										...
										<?
                                            	...
                                            	<tr>
                                                    <td id="td" colspan="2"> 
                                                        Catatan : <br />
                                                        <b><em><?php if (!empty($disposisi[0]['catatan'])) { echo word_limiter($disposisi[0]['catatan'],30,'<a style="cursor:pointer;" onclick="doIt(\'#lengkapx\');"> selengkapnya</a>'); } ?></em></b>
													...
													if (!empty($detail_terima[0]['detail_terima'])) {
                                                        ...
                                                        <? } else { if (!empty($detail_terima[0]['detail_korespondensi'])) {
                                    ...
                                    if ($if_lanjutan>0){ ?>
                                             ...
                                             <table id="">
                                                ...
                                                <? foreach($user_disposisi_lanjutan as $key) { ?>
                                                    <li><?php if ($key['user_kd']==$level_id) 
														{ echo "<b><i>".$key['user_namalengkap']."</i></b>"; } 
														else { echo $key['user_namalengkap']; } ?> 
                                                        <?php if ($key['detail_terima']=='Y'){
                                                ...
                                                <td id="td" colspan=2">
                                                <b>Catatan :</b><br>
                                                	<?php echo $disposisi_lanjutan_kd[0]['disposisi_lanjutan_catatan']; ?>
                                                </td>
                                                </tr> 
														<?	
															}
