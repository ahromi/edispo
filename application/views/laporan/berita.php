...
if (!empty($username)) {
    ...
    <div id="content">
        <div id="main-content">
            <h1>Laporan & Statistik Berita Perwakilan</h1> 
            <fieldset>
                <div id="box-right">
                    <h2>Statistik Berita Perwakilan</h2>
                    <!-- modal content -->
                                    ...
                                    if (AC_FL_RunContent == 0 || DetectFlashVer == 0) {
                                        ...
                                        if (hasRightVersion) {
                                            AC_FL_RunContent(
                                                    ...
                                                    'movie', 'charts',
                                                    'src', '../../../charts/charts',
                                                    'FlashVars', 'library_path=<?php echo base_url(); ?>charts/charts_library&xml_source=<?php echo base_url(); ?>index.php/laporan/berita/xml_berita/',
                                                    'id', 'my_chart',
                                                    'name', 'my_chart',
                                                    'menu', 'true',
                ...
                <div id="box-left">
                    <h2>Laporan Berita Perwakilan</h2>
                    <?php echo form_open_multipart('laporan/berita/'); ?> 
                    <fieldset>
                        <?php if (!empty($notif)) { ?>
                        ...
                        <ul class="align-list">
                            ...
                            <li>
                                ...
                                <select id="addarticle-category" name="jenis_kd">
                                    ...
                                    <?php foreach ($jenis as $val) { ?>
                                        <option selected="selected" value="<?= $val['jenis_kd']; ?>"><?= $val['jenis_nama']; ?></option>
                                    <?php } ?>
                                </select>
                            </li>
                            <li>
                            ...
                            <li>
                                <label for="addarticle-category">Pendisposisian Berita ?</label>
