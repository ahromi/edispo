...
<chart>
	...
	<chart_data>
		<row>
			...
			<?php foreach($statistik as $val){ ?>
				<string><?php echo $val['fungsi'];?></string>
			<?php } ?>
		</row>
		<row>
			<string></string>
	...
	<chart_rect x='230' y='40' width='200' height='200' positive_alpha='0' />
	...
	<draw>
		...
		<text shadow='low' color='0' alpha='20' size='30' x='0' y='260' width='500' height='50' v_align='middle'>Statistik Disposisi Berita <?php echo date('Y');?></text>
