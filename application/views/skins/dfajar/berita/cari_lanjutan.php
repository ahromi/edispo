...
?>
 					<div id="content">
                        <div id="main-content">
                            <h2>Pencarian Arsip Dokumen Biasa</h2>
                                    ...
                                    <ul class="align-list">
                                        ...
                                        <li>
                                            <label for="addarticle-category">Perihal</label>
                                             <textarea id="addarticle-title" name="perihal_berita" /><?=$perihal;?></textarea>
                                        </li>
                                        <li>
                                            <label></label>
								...
								<? } else {
                                    ...
                                    <tr id="row">
                                        ...
                                        <? if ($level_id=='3'){ ?>
                                         ...
                                         <? } ?>
                                        <td width="50"><a href="<?=base_url();?>index.php/berita/detail_fungsi/id/<?=$val['arsip_kd'];?>" class="tiptip-top" title="Detail"><img src="<?=base_url();?>resources/images/icon_view.png" alt="Detail" /></a></td>
                                    </tr>
                                    <? } ?>
          <? } ?>
                                 </tbody>
