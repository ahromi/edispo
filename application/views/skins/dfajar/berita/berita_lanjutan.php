                            ...
                            <ul class="nav nav-pills" role="tablist">
                                <li role="presentation" class="active">
                                    <?php if ($this->session->userdata('SESSION_KOORDINATOR') == 'Y') { ?>
                                        <a style="width: 200px;" title="Daftar Berita" href="<?= base_url(); ?>index.php/berita/berita<?= $url; ?>/index" class="btn btn-sm btn-success btn-margin">Daftar Berita</a>
                                    <?php } else {
                                        ?>
                                        <a style="width: 200px;" title="Daftar Berita" href="<?= base_url(); ?>index.php/berita/berita<?= $url; ?>/index" class="btn btn-sm btn-success btn-margin">Daftar Berita</a>
                                    <?php } ?>
                                ...
                                if ($this->session->userdata('SESSION_KOORDINATOR') == 'Y') {
                                    ...
                                    if ($this->session->userdata('SESSION_DISPOSISI_FUNGSI') == 'Y') {
                                        echo '<li role="presentation" class="active"><a style="width: 200px;" href="' . base_url() . 'index.php/berita/berita_fungsi/undisposed" class="btn btn-info btn-sm">Menunggu Disposisi</a></li>';
                                    }
                                        ...
                                        if (empty($berita)) {
                                            ...
                                            foreach ($berita as $key => $val) {
                                                ...
                                                <tr id="row">
                                                    ...
                                                    <td width="12%"><a href="<?= base_url(); ?>index.php/berita/detail_fungsi/id/<?= $val['arsip_kd']; ?>"><?= $val['arsip_kd']; ?></a></td>
                                                    <td width="15%"><a href="<?= base_url(); ?>index.php/berita/detail_fungsi/id/<?= $val['arsip_kd']; ?>" class="agreen"><?= $val['berita_kd']; ?></a></td>
